<head>
 ...
 <title>User canceled membership</title> 
               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Your membership for {{ $user->name }} At FindSurrogate has been cancelled.</p>
                  ...
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">End Date: <strong>{{ $subscription->ends_at }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
