<head>
 ...
 <title>New Membership Checkout on FindSurrogate</title> 
               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">New Membership Checkout on FindSurrogate</p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Package: <strong>{{ $subscription->package_name }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Membership Fee: <strong>{{ $price }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                    <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Start Date: <strong>{{ $subscription->created_at }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Type: <strong>{{ $user->user_type }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Name: <strong>{{ $user->name }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  @if($user->provider)
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Registered with <strong>{{ $user->provider }}</strong></p>
                  @else
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Email: <strong>{{ $user->email }}</strong></p>
                  @endif
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Country: <strong>{{ $user->country }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">State: <strong>{{ $user->state }}</strong></p>
                 </th> 
                </tr> 
               </tbody> 
              </table> 
