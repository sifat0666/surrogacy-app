<head>
 ...
 <title>{{$userWhoFavorited->name}} added you to favorites</title> 
...
<body bgcolor="#f5f8fa" style="-moz-box-sizing: border-box; -ms-text-size-adjust: 100%; -webkit-box-sizing: border-box;  -webkit-text-size-adjust: 100%; margin: 0; background: #f5f8fa !important; background-color: #f5f8fa !important; box-sizing: border-box;   font-size: 14px; min-width: 100%; width: 100% !important;"> 
 <span class="preheader" style="-moz-hyphens:none;-ms-hyphens:none;-webkit-hyphens:none;color:transparent;display:none!important;font-size:1px;hyphens:none;line-height:1px;max-height:0;max-width:0;mso-hide:all!important;opacity:0;overflow:hidden;visibility:hidden;word-break:keep-all">{{$userWhoFavorited->name}} added you to favorites</span>
               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <h3 style=" text-align: left; color: #164D74;  font-size: 18px; font-weight: 400;  line-height: 1.5; margin: 0; margin-bottom: 5px; ">Dear {{ $user->name }},</h3> 
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">{{$userWhoFavorited->name}} favorited your profile on FindSurrogate.</p>
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                 </th> 
                </tr> 
               </tbody> 
