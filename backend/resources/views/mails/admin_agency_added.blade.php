<head>
 ...
 <title>New Profile Added on FindSurrogate</title> 
               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Agency profile added. User details:</p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Username: <strong>{{ $user->agency->name }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  ...
                  @else
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Email: <strong>{{ $user->agency->email }}</strong></p>
                  @endif
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Member Type: <strong>{{ $user->user_type }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
