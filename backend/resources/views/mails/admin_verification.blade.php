             ...
             <th class="small-12 large-12 columns first last" style="padding: 0; padding-left: 35px; padding-right: 35px;  width: 545px; "> 
              <table style=" border-spacing: 0;  padding: 0;   width: 100%; "> 
               <tbody> 
                ...
                <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74; line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;">
    Verification Request Received From {{ $user->name }},
    <a href='http://www.findsurrogate.com/surrogates/surrogate-details/{{ $user->id }}'>
        www.findsurrogate.com/surrogates/surrogate-details/{{ $user->id }}
    </a>
</p>
