<head>
 ...
 <title>Agency profile deleted</title> 
               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Agency profile deleted. User details:</p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Agency Name: <strong>{{ $user->agency->name }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  @if($user->agency->provider)
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Agency Registered with <strong>{{ $user->agency->provider }}</strong></p>
                  @else
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Agency Email: <strong>{{ $user->agency->email }}</strong></p>
                  @endif
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Profile Type: <strong>{{ $user->user_type }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Profile Name: <strong>{{ $user->name }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Profile Country: <strong>{{ $user->country }}</strong></p>
                  <p class="mb0" style="text-align: left; font-size: 5px; height: 5px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Profile State: <strong>{{ $user->state }}</strong></p>
                 </th> 
                </tr> 
               </tbody> 
              </table> 
