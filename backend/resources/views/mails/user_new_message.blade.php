               ...
               <tbody> 
                <tr> 
                 <th style="padding: 0;  " > 
                  ...
                  <h3 style=" text-align: center; color: #164D74;  font-size: 24px; font-weight: 400;  line-height: 1.5; margin: 0; margin-bottom: 15px; ">You have new message</h3> 
                  <h3 style=" text-align: left; color: #164D74;  font-size: 18px; font-weight: 400;  line-height: 1.5; margin: 0; margin-bottom: 5px; ">Hi {{ $recipient->name }},</h3> 
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">You have received a new message.</p>
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                  <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Sender: <b>{{$sender->name}}</b></p>
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                   <p class="mb0" style="text-align: left; font-weight: normal; color: #164D74;     line-height: 1.5; margin: 0; margin-bottom: 0 !important; padding: 0;  ">Message: <b>{{$text}}</b></p>
                  <p class="mb0" style="text-align: left; font-size: 15px; height: 15px;   line-height: 1; margin: 0; margin-bottom: 0 !important; ">&nbsp;</p> 
                 </th> 
                </tr> 
               </tbody> 
