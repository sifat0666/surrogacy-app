...
import { useRegisterIndendedParentsMutation } from "@/services/auth-api";
...
const ContactInfo = ({ handleChange }: { handleChange: () => void }) => {
  const [mutation] = useRegisterIndendedParentsMutation();
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      formData.append("user_type", "Intended Parent");
      ...
      formData.append("surrogate_location", surrogacy?.surrogateLocation);
      ...
      formData.append("have_frozen_embryos", surrogacy?.frozenEmbroys);
      ...
      formData.append("is_willing_to_travel", about?.willingTravel);
