  ...
  const methods = useForm<any>({
    resolver: yupResolver(
      Yup.object().shape({
        ...
        surrogateLocation: Yup.string().required("Required Field!"),
        firstSurrogacyJourney: Yup.string().required("Required Field!"),
        workingAgency: Yup.string().required("Required Field!"),
        frozenEmbroys: Yup.string().required("Required Field!"),
        typeJourney: Yup.string().required("Required Field!"),
        // memberships: Yup.string().required("Required Field!"),
      })
    ),
    defaultValues: {
      typeSurrogacy: "",
